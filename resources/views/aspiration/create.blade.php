	    ...
	    <div class="col-md-7 m-auto">
	        ...
	        <form action="{{ route('aspirations.store') }}" method="POST">
	            ...
	            <div class="form-group">
	                ...
	                <textarea type="email" class="form-control" aria-describedby="emailHelp"
	                    placeholder="Enter Aspiration" name="aspiration" value="{{ old('aspiration') }}"></textarea>
	            ...
	            <div class="form-group">
	                ...
	                <select class="custom-select" id="category" required name="aspiration_category_id">
	                    ...
	                    <option value="{{ $category->id }}" {{ old('aspiration_category_id') == $category->id ? 'selected' : '' }}>{{ $category->category }}</option>
	                    @endforeach
	                </select>
